...
export default function PDFScreen({ route }: any) {
    ...
    const gamePage = `
        <div class="flex-container" style="justify-content: center">
            <div style="width: 280px; margin: 5px 0px; line-height: 15px;">
                <strong style="text-align: center;">SLOVENSKÝ ZVÄZ ĽADOVÉHO HOKEJA VYÚČTOVANIE</strong>
            </div>
        </div>
        <div class="flex-container" style="justify-content: center; ">
            <div style="width: 380px; margin: 0px; line-height: 15px;">
        ...
        <div class="flex-container">
            <div style="margin: 5px 5px; ">
                <strong style="text-align: center;">Vyučtovanie bude spracované iba v prípade vyplnenia, doloženia
                    originálnych príslušných dokladov a podpísania účtujúceho.</strong>
            </div>
        </div>
    `;
        ...
        <>
            {isWeb ? (
                ...
                >
                    ...
                    <div
                        style={{ maxWidth: 645, borderWidth: 1, borderColor: 'red' }}
